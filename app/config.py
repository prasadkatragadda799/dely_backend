...
class Settings(BaseSettings):
    ...
    SELLER_ADDRESS_LINE1: str = os.getenv("SELLER_ADDRESS_LINE1", "VIMTI LAXIRAMPUR HEERA PATTI SADAR AZAMGARH")
    SELLER_ADDRESS_LINE2: str = os.getenv("SELLER_ADDRESS_LINE2", "")
    SELLER_CITY: str = os.getenv("SELLER_CITY", "Azamgarh")
    SELLER_STATE: str = os.getenv("SELLER_STATE", "Uttar Pradesh")
    SELLER_PINCODE: str = os.getenv("SELLER_PINCODE", "276001")
    SELLER_GSTIN: str = os.getenv("SELLER_GSTIN", "09AAFCF9954NTZQ")
    SELLER_PAN: str = os.getenv("SELLER_PAN", "AAFCF9954N")
    SELLER_FSSAI: str = os.getenv("SELLER_FSSAI", "12724028000313")
    SELLER_FSSAI_LINK: str = os.getenv("SELLER_FSSAI_LINK", "https://foscos.fssai.gov.in/")
    SELLER_PHONE: str = os.getenv("SELLER_PHONE", "9473691259")
    SELLER_EMAIL: str = os.getenv("SELLER_EMAIL", "foodmarketingpvtltd@gmail.com")
